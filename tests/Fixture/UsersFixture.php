...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'perfil' => ['type' => 'index', 'columns' => ['role'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'role_key' => ['type' => 'foreign', 'columns' => ['role'], 'references' => ['roles', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-04-29 18:50:42',
                'modified' => '2018-04-29 18:50:42'
            ],
        ];
        parent::init();
    }
